...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { curso: @aluno.curso, instituicao: @aluno.instituicao, nome_aluno: @aluno.nome_aluno, nota_aluno: @aluno.nota_aluno } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { curso: @aluno.curso, instituicao: @aluno.instituicao, nome_aluno: @aluno.nome_aluno, nota_aluno: @aluno.nota_aluno } }
